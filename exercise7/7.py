# -*- coding: utf-8 -*-
"""
Created on Sat Nov 05 13:39:07 2016
...
class chaotic_pendulums:
    def __init__(self,length=9.8,q=0.5,initial_theta=0.2,initial_theta1=(0.2-0.001),initial_omega=0,initial_omega1=0,F_d=1.2,Omega_d=2.0/3,step_time=0.04,total_time=120):
